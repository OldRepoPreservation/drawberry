...
- (id)copyWithZone:(NSZone *)zone
  {
  CTGradient2 *copy = [[[self class] allocWithZone:zone] init];
...
- (CTGradient2 *)gradientWithAlphaComponent:(float)alpha
  {
  id newInstance = [[[self class] alloc] init];
...
- (CTGradient2 *)gradientWithBlendingMode:(CTGradientBlendingMode)mode
  {
  CTGradient2 *newGradient = [self copy];  
...
- (CTGradient2 *)addColorStop:(NSColor *)color atPosition:(float)position
  {
  CTGradient2 *newGradient = [self copy];
...
- (CTGradient2 *)removeColorStopAtPosition:(float)position
  {
  CTGradient2 *newGradient = [self copy];
...
- (CTGradient2 *)removeColorStopAtIndex:(unsigned)index
  {
  CTGradient2 *newGradient = [self copy];
