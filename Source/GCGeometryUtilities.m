...
/// scope:			global
/// description:	forms a rectangle from two corner points
/// 
...
NSRect		CentreRectOnPoint( NSRect inRect, NSPoint p )
{
	...
	inRect.origin.x = p.x - ( inRect.size.width * 0.5f );
	inRect.origin.y = p.y - ( inRect.size.height * 0.5f );
	return inRect;
}
